...
\organizacion[Alianza]{Latinoamerica unida}
\autor[Alianza]{}
\sistema[Sistema de herramientas para estudiantes]{}
\proyecto[PruebaProyecto]{Version Alfa}
\documento{}{Sistema de herramientas para estudiantes }{\RELEASE{1.0}}% {\DRAFT{\today}} 

\entregable{}{\Large{Sistema de administración de entradas y salidas de una farmacia}}

\superviso[Nombre de la empresa que supervisa]{Nombre de la persona}
\aprobo[area que aprueba]{nombrel del responsable} % Responsable Técnico (Contraparte)
...
%	\cfinput{proceso/proceso}
	...
	%modulo1
%	\cfinput{casouso/cu1.1.2/uc} %agregar producto al carrito de compras
%	\cfinput{casouso/cu1.1.2.1/uc} %agregar producto al carrito de compras con busqueda
%	\cfinput{casouso/cu1.1.5/uc} %cobrar
	
%	\cfinput {casouso/cu1.2.1/uc} %buscar por ticket
%	\cfinput {casouso/cu1.2.1.3/uc} %devolver productos seleccionados
%	\cfinput {casouso/cu1.3/uc} %Comprar a proveedor
%	\cfinput {casouso/cu1.5.1/uc} %Registrar Producto
